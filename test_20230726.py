...
def merge_images(Img1,Img2,Img1_bin):
    ...
    for x in range(w):
        for y in range(h):
            if (Img1_bin[y,x][0] == 255 and Img1_bin[y,x][1] == 255):
...
if __name__ == '__main__':
    ...
    image1 = cv2.resize(image1, (540, 960), interpolation=cv2.INTER_AREA)
    image2 = cv2.resize(image2, (540, 960), interpolation=cv2.INTER_AREA)
    image1 = image1[250:,:]
    image2 = image2[250:,:]
